document.addEventListener('DOMContentLoaded', () => {
    ...
    const animationObserver = new IntersectionObserver((entries, observer) => {
        entries.forEach((entry, index) => {
            if (entry.isIntersecting) {
                // Add a staggered delay based on the order of appearance
    ...
    // Hero Section Animation - keeping it separate for its specific logic
    ...
    const createCharts = () => {
        ...
        // Global Chart Defaults for a modern look
        ...
        // Pie Chart: Most Desired Features
        const pieChart = new Chart(pieCtx, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    data: [40, 30, 20, 10],
                    backgroundColor: [
                        'rgba(9, 167, 3, 0.85)',    // Primary Green
                        'rgba(226, 122, 37, 0.85)',   // Secondary Orange
                        'rgba(53, 122, 189, 0.85)',  // Dark Blue
                        'rgba(130, 174, 192, 0.85)'  // Light Blue
                    ],
                    borderColor: [
                        '#FFFFFF',
                        '#FFFFFF',
        ...
        const barChart = new Chart(barCtx, {
            ...
            options: {
                responsive: true,
                maintainAspectRatio: false,
                indexAxis: 'y', // Create horizontal bars
                animation: {
                    duration: 1000,
                    easing: 'easeOutCubic'
                },
    ...
    // Observer to animate charts when they become visible
    ...
    // Legacy percentage chart animation logic
